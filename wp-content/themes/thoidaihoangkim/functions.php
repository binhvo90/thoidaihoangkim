<?php
/**
 * thoidaihoangkim functions and definitions
 *
...
if ( ! function_exists( 'thoidaihoangkim_setup' ) ) :
	/**
	 ...
	 */
	function thoidaihoangkim_setup() {
		/*
		 * Make theme available for translation.
		 * Translations can be filed in the /languages/ directory.
		 * If you're building a theme based on thoidaihoangkim, use a find and replace
		 * to change 'thoidaihoangkim' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'thoidaihoangkim', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'thoidaihoangkim' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'thoidaihoangkim_custom_background_args', array(
...
add_action( 'after_setup_theme', 'thoidaihoangkim_setup' );
 ...
 */
function thoidaihoangkim_content_width() {
	// This variable is intended to be overruled from themes.
	// Open WPCS issue: {@link https://github.com/WordPress-Coding-Standards/WordPress-Coding-Standards/issues/1043}.
	// phpcs:ignore WordPress.NamingConventions.PrefixAllGlobals.NonPrefixedVariableFound
	$GLOBALS['content_width'] = apply_filters( 'thoidaihoangkim_content_width', 640 );
}
add_action( 'after_setup_theme', 'thoidaihoangkim_content_width', 0 );
 ...
 */
function thoidaihoangkim_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'thoidaihoangkim' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'thoidaihoangkim' ),
...
add_action( 'widgets_init', 'thoidaihoangkim_widgets_init' );
...
add_action( 'wp_enqueue_scripts', 'thoidaihoangkim_scripts' );
